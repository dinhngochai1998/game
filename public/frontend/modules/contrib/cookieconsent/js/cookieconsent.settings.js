window.cookieconsent_options = {
    ...
    // The url of your cookie policy. If itâ€™s set to null, the link is hidden.
    ...
    // The number of days Cookie Consent should store the userâ€™s consent information for.
