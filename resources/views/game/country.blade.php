            ...
            <main id="main">
                <div id="block-pegi-content">
                    <div id="results" typeof="WebPage" class="page">
                        <h1><span property="schema:name">Đất nước</span></h1>
                                    ...
                                    <div class="game-content" style="padding: 25px 25px 0px;">
                                        <div class="description">
                                            <div class="age-rating">
                                                <a href="{{ route('wave.cate.genre.game', $country->slug) }}">
                                                    <img src="{{ asset('/storage/'.$country->image) }}" alt="" />
                                                </a>
                                            </div>
                                            <div class="info" style="width: 80%;">
                                                <h3><a style="font-size: 24px;" href="{{ route('wave.cate.genre.game', $country->slug) }}">{{ $country->name }}</a></h3>
                                                <br>
                                                {{-- <span class="publisher">Đất nước :{{ $country->name }}</span> --}}
                                                <span class="content-info">{{ $country->description }}</span>
                                            </div>
